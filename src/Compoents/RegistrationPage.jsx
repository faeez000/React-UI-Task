...
const RegistrationPage = () => {
  ...
  return (
    <div className='background-3' style={{ backgroundImage: "linear-gradient(#8b9da9, #fff6e4)", boxShadow: "inset 0 0 100px hsla(0,0%,0%,.3)", minHeight: "100vh"}}>
      <div className="shadow p-3 mb-5 bg-body-tertiary rounded" 
      style={{width:"500px",height:"500px" ,backgroundColor:"white",display: "block", marginLeft: "auto",marginRight: "auto", }}>
        <div>
            ...
            className="d-flex align-items-center mb-3 link-dark text-decoration-none" alt="icon"
            style={{width:"80px", height:"80px" , display: "block", marginLeft: "auto",marginRight: "auto",}} />
        </div>
        <div>
            <h3 style={{color:"#8b9da9"}}>Book Your Free Class</h3>
        </div>
        <div style={{marginTop:"5%"}}>
            <Form>
                <Form.Group as={Row} className="mb-3" controlId="exampleForm.ControlInput1">
                    ...
                    <Col sm="8">
                    <Form.Control  type="input" ref={nameRef} placeholder="Enter Your Full Name" style={{marginRight:"4%"}} />
                    </Col>
                </Form.Group>
                <Form.Group as={Row} className="mb-3" controlId="exampleForm.ControlTextarea1">
                    <Form.Label column sm="3">Contact no.</Form.Label>
                    <Col sm="8">
                    <Form.Control type="number" ref={numberRef} placeholder="Enter Your Contact Number" style={{marginRight:"4%"}}/>
                    </Col>
                </Form.Group>
            </Form>
        </div>
        <div style={{marginTop:"5%"}}>
            <h6 style={{color:"#8b9da9"}} >By clicking the 'Schedule a FREE Class' button you agree to Whitehat Jr Terms & Conditions.</h6>
        </div>
        <div style={{marginTop:"5%",textAlign:"center"}}>
            <Button onClick={onRegisterClick} variant="primary">REGISTER</Button>
        </div>
        <div style={{marginTop:"5%",textAlign:"center"}}>
